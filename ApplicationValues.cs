...
namespace TequaCreek.BloxGuardianMessageProcessingService
{
    public class ApplicationValues
    {
        ...
        public const int ALLOWED_COMMUNICATION_PATH_QUERY_RESULT_COLUMN_OFFSET_INGAME_ENDPOINT_INTERNAL_ID = 0;
        public const int ALLOWED_COMMUNICATION_PATH_QUERY_RESULT_COLUMN_OFFSET_INGAME_ENDPOINT_EXTERNAL_ID = 0;
